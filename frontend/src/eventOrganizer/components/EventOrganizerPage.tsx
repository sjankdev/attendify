    ...
    <Layout>
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 p-6">
        ...
        <p className="text-lg text-gray-600 mb-6 text-center max-w-2xl">
          As the Event Organizer, you can manage events, invitations, and
          participants. Use the options below to create events, invite
          participants, and view event details.
        </p>
        ...
        <div className="mt-8 bg-white p-4 rounded-lg shadow-md text-center">
          ...
          <p className="text-gray-600">
            If you have any questions about managing events, please contact
            support.
          </p>
        </div>
      </div>
