...
const CompanyParticipantsPage: React.FC = () => {
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold mb-6">Your company participants</h2>
      ...
      <div className="absolute top-6 right-6">
        <button
          className="flex items-center px-6 py-3 bg-[#6167E0] text-white rounded-lg transition-colors focus:ring-2 focus:ring-blue-500"
      ...
      <div className="mb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-white">
          <div className="p-6 bg-[#630472] rounded-lg shadow-md hover:shadow-xl transition-shadow">
            {" "}
          ...
          <div className="p-6 bg-[#BA10AA] rounded-lg shadow-md hover:shadow-xl transition-shadow">
            {" "}
            <div className="flex items-center space-x-4">
                ...
                <ul className="mt-4 space-y-2">
                  ...
                  {participant.joinedEventCount > 3 &&
                    participant.showAllEvents && (
                      <>
                        {participant.eventLinks.slice(3).map((link, index) => (
                          <li key={index + 3}>
                            <Link
                              to={`/event-details/${link.split("/").pop()}`}
                              className="text-teal-500 hover:underline"
